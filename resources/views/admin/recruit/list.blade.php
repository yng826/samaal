                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-outline-warning btn-xs" href="/eng/admin/recruit/{{ $recruit->id }}/edit">수정</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 text-right">
                    <a class="btn btn-primary text-white" href="/eng/admin/recruit/create">채용 공고 추가</a>
                </div>
            </div>
        </div>
    </div>
