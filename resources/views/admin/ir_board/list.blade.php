                    ...
                    <table class="table"  style="table-layout: fixed;">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-outline-info btn-xs mr-2" href="/kor/admin/ir_board/file-download?id={{ $board->id }}&type=img">이미지파일</a>
                                <a class="btn btn-outline-info btn-xs" href="/kor/admin/ir_board/file-download?id={{ $board->id }}&type=pdf">PDF파일</a>
                            </td>
                            <td class="text-center">{{ $board->updated_at ?? $board->created_at}}</td>
                            <td class="text-center" ><a class="btn btn-outline-warning btn-xs" href="/kor/admin/ir_board/{{$board->id}}/edit">수정</a></td>
                        </tr>
                        @endforeach
                    </table>
                </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 text-right">
                    <a class="btn btn-primary text-white" href="/kor/admin/ir_board/create">IR공고 추가</a>
                </div>
            </div>
        </div>
    </div>
