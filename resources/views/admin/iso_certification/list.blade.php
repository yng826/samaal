                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-outline-info btn-xs mr-2" href="/kor/admin/iso_certification/file-download?id={{ $certification->id }}&type=img">이미지파일</a>
                                <a class="btn btn-outline-info btn-xs" href="/kor/admin/iso_certification/file-download?id={{ $certification->id }}&type=pdf">PDF파일</a>
                            </td>
                            <td class="text-center">{{ $certification->updated_at ?? $certification->created_at}}</td>
                            <td class="text-center">
                                <a class="btn btn-outline-warning btn-xs" href="/kor/admin/iso_certification/{{ $certification->id }}/edit">수정</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 text-right">
                    <a class="btn btn-primary text-white" href="/kor/admin/iso_certification/create">ISO인증서 추가</a>
                </div>
            </div>
        </div>
    </div>
