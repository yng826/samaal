        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 text-right">
                    ...
                    <button type="button" class="btn btn-primary text-white" onClick="location.href='/eng/admin/menu/create?parent_id=0&depth=0'">추가</button>
                </div>
            </div>

            <form action="/eng/admin/menu/order-update" id="order-form" class="hide" method="POST">
                @csrf
