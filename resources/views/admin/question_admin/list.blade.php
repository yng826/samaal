...
<div class="container question_list">
                ...
                <div class="col-12">
                    <table class="table"  style="table-layout: fixed;">
                        ...
                        <tr>
                            ...
                            @if ($board->state_yn == 'y')
                                <td class="text-center" ><a class="btn btn-outline-info btn-xs" href="/kor/admin/question_admin/{{$board->id}}">상세보기</a></td>
                            @else
                                <td class="text-center" ><a class="btn btn-outline-warning btn-xs" href="/kor/admin/question_admin/{{$board->id}}/edit">관리</a></td>
                            @endif
    ...
    <form action="/kor/admin/question/" id="question-list" method="POST">
        @method('DELETE')
