                ...
                <div class="col-12">
                    <table class="table"  style="table-layout: fixed;">
                        ...
                        <tr>
                            ...
                            <td class="text-center" ><a class="btn btn-outline-warning btn-xs" href="/eng/admin/business/{{$item->id}}/edit">수정</a></td>
                        </tr>
                        @endforeach
                    </table>
                </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-12 text-right">
                    <a class="btn btn-primary text-white" href="/eng/admin/business/create">제품 추가</a>
                </div>
            </div>
        </div>
    </div>
