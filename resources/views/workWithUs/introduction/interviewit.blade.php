...
@section('qna-01')
    ...
    <p class="answer">
        IT 부문은 안정적이고 효율적인 시스템 운영을 위해 유지보수 및 개발 업무를 지속적으로 수행하고 있으며
        새로운 시스템 도입을 기획하고 검증하는 업무를 수행하고 있습니다.
    </p>
@endsection
...
@section('qna-02')
    ...
    <p class="answer">
        정보통신 및 컴퓨터공학 계열을 전공하고 직무역량으로는 분석적/전략적 사고와 인프라, 네트워크, 보안, 개발 관련 기본지식이 필요합니다. 타 부서와의 협업이 중요한 부서로 적극적으로 소통하며 협력적인 관계를 유지하는게 중요한 요소입니다.
    </p>
@endsection
