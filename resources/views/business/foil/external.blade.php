...
@section('swiper-container')
    <div class="swiper-slide"><div class="slide-img" style="background-image:url(/eng/images/business/foil/img_external.jpg);"></div></div>
    <div class="swiper-slide"><div class="slide-img" style="background-image:url(/eng/images/business/foil/img_external_hover.jpg);"></div></div>
@endsection
