<footer class="footer">
    ...
    <div class="footer__wrap">
        ...
        <div class="footer__inner">
            ...
            <div class="droplist-box">
                <button class="droplist-box__button" onClick="location.href='/kor/other/privacy'">개인정보처리방침</button>
                <button class="droplist-box__button" onClick="location.href='/kor/other/email_security'">이메일무단수집거부</button>
                <!-- <ul class="droplist">
