...
<main class="about-storyNews contents-wrap">
    ...
    <div class="about-storyNews__contents">
        ...
        <div class="pagination">
            <a href="/eng/about-us/story-news?page=1" class="pagination__button-prev"></a>
            @for($i=1; $i<$cnt+1; $i++)
                <?php
                    $style='';
                ?>
                ...
                @endif
                 @if ($_GET['page'] == $i)
                    ...
                    ?>
                 @endif
                <a href="/eng/about-us/story-news?page={{ $i }}" class="pagination__number" style="{{ $style }}">{{ $i }}</a>
            @endfor
            <a href="/eng/about-us/story-news?page={{ $cnt }}" class="pagination__button-next"></a>
        </div>
    </div>
