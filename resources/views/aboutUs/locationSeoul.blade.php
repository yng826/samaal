@php
    $bodyClass = 'about';
    $meta_title = 'Sama Aluminium | Seoul Office';
    $meta_desc = 'Seoul Office';
@endphp
    ...
    <div class="about-location__contents">
        <div class="swiper-container about-location__swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="/eng/images/about/location/seoul/img_location_01.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/eng/images/about/location/seoul/img_location_02.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/eng/images/about/location/seoul/img_location_03.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/eng/images/about/location/seoul/img_location_04.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/eng/images/about/location/seoul/img_location_05.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/eng/images/about/location/seoul/img_location_06.jpg" alt=""></div>
            </div>
